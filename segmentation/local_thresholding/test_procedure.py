...
from local_thresholding.procedure import generate_segmentation


image_names = ['angled', 'capped', 'dark', 'egg', 'empty', 'medium', 'small']
data_dir = 'data/broodmapper/'
base_dir = 'local_thresholding/'
...
# angled <Validation TPR 0.85 PPV 0.84/>
# capped <Validation TPR 0.65 PPV 0.92/>
# dark <Validation TPR 0.91 PPV 0.96/>
# egg <Validation TPR 0.95 PPV 0.94/>
# empty <Validation TPR 0.95 PPV 0.96/>
# medium <Validation TPR 0.82 PPV 0.83/>
# small <Validation TPR 0.89 PPV 0.89/>
